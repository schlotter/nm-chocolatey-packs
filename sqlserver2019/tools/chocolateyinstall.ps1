...
function BuildConfigurationFile()
{
    ...
    if (Test-Path env:\choco:sqlserver2019:Q or QUIET){Add-Content $configFile "Q or QUIET=`"$env:choco:sqlserver2019:Q or QUIET`""}
    if (Test-Path env:\choco:sqlserver2019:QS or QUIETSIMPLE){Add-Content $configFile "QS or QUIETSIMPLE=`"$env:choco:sqlserver2019:QS or QUIETSIMPLE`""}
